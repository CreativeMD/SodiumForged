...
public class CuboidMixin implements ModelCuboidAccessor {
    ...
    private void onInit(ModelPart.Cube parent, float value, int u, int v, float x, float y, float z, float sizeX, float sizeY, float sizeZ, float extraX, float extraY, float extraZ, boolean mirror, float textureWidth, float textureHeight, Set<Direction> renderDirections) {
